...
export default function Experience() {
  ...
  return (
    <section className="w-screen h-screen flex-shrink-0 flex items-center justify-center relative overflow-hidden bg-gradient-to-r from-yellow-400 to-orange-400 dark:from-yellow-800 dark:to-orange-800">
      ...
      <div
        ...
        className="relative z-10 text-center max-w-3xl mx-auto px-4 overflow-y-auto h-full py-12 scrollbar-hide"
